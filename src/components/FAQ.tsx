...
const faqs = [
  ...
  { cat: 'Protocols', q: 'What models does Venta AI Labs support?', a: 'Venta AI Labs supports all major frontier models including GPT-4o, Claude 3.5 Sonnet, Gemini Pro, Mistral Large, and open-source models via Groq or self-hosted Ollama. You can mix models within a single workflow.' },
  { cat: 'Licensing', q: 'What are the pricing tiers?', a: 'Venta AI Labs offers three tiers: Starter (solo founders, $299/mo), Growth (teams up to 25, $1,499/mo), and Enterprise (custom). All plans include unlimited workflows and nodes. Enterprise adds dedicated infrastructure, SLA guarantees, and white-glove onboarding.' },
];
